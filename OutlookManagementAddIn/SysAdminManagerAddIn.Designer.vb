...
Partial Public NotInheritable Class SysAdminManagerAddIn
    ...
    Protected Overrides Sub Initialize()
        ...
        Globals.SysAdminManagerAddIn = Me
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _SysAdminManagerAddIn As SysAdminManagerAddIn
    ...
    Friend Shared Property SysAdminManagerAddIn() As SysAdminManagerAddIn
        Get
            Return _SysAdminManagerAddIn
        End Get
        Set
            If (_SysAdminManagerAddIn Is Nothing) Then
                _SysAdminManagerAddIn = value
            Else
    ...
    Friend Shared ReadOnly Property FormRegions() As ThisFormRegionCollection
        Get
            If (_ThisFormRegionCollection Is Nothing) Then
                _ThisFormRegionCollection = New ThisFormRegionCollection(Globals.SysAdminManagerAddIn.GetFormRegions)
            End If
...
Partial Friend NotInheritable Class ThisFormRegionCollection
    ...
    Friend Overloads Default ReadOnly Property Item(ByVal explorer As Microsoft.Office.Interop.Outlook.Explorer) As WindowFormRegionCollection
        Get
            Return CType(Globals.SysAdminManagerAddIn.GetFormRegions(explorer, GetType(WindowFormRegionCollection)),WindowFormRegionCollection)
        End Get
    End Property
    ...
    Friend Overloads Default ReadOnly Property Item(ByVal inspector As Microsoft.Office.Interop.Outlook.Inspector) As WindowFormRegionCollection
        Get
            Return CType(Globals.SysAdminManagerAddIn.GetFormRegions(inspector, GetType(WindowFormRegionCollection)),WindowFormRegionCollection)
        End Get
    End Property
End Class
